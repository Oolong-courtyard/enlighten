    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_superuser', models.CharField(choices=[('true', '是'), ('false', '否')], default='false', max_length=10, verbose_name='管理员')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('add_time', models.DateTimeField(default=datetime.datetime(2020, 9, 2, 15, 38, 47, 139879), verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '短信验证码',
